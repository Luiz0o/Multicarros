...
export const notFound = async (message: string = 'Recurso não encontrado'): Promise<HttpResponse> => ({
    statusCode: 404,
    body: { error: message }
});

export const internalServerError = async (error: Error | string): Promise<HttpResponse> => ({
    statusCode: 500,
    body: {
