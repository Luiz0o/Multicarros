...
var funcionarioController_exports = {};
__export(funcionarioController_exports, {
  createFuncionario: () => createFuncionario,
  deleteFuncionario: () => deleteFuncionario,
  getAllFuncionarioes: () => getAllFuncionarioes,
  getFuncionarioById: () => getFuncionarioById,
  updateFuncionario: () => updateFuncionario
});
module.exports = __toCommonJS(funcionarioController_exports);
