...
var acessorioController_exports = {};
__export(acessorioController_exports, {
  createAcessorio: () => createAcessorio2,
  deleteAcessorio: () => deleteAcessorio2,
  getAcessorioById: () => getAcessorioById2,
  getAllAcessorios: () => getAllAcessorios2,
  updateAcessorio: () => updateAcessorio2
});
module.exports = __toCommonJS(acessorioController_exports);
