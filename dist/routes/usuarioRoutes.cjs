...
router.get("/usuarios", getAllUsuarios3).get("/usuarios/:id", getUsuarioById3).post("/usuarios", createUsuario3).patch("/usuarios/:id", updateUsuario2).delete("/usuarios/:id", deleteUsuario2);
var usuarioRoutes_default = router;
