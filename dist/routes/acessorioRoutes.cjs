...
var acessorioRoutes_exports = {};
__export(acessorioRoutes_exports, {
  default: () => acessorioRoutes_default
});
module.exports = __toCommonJS(acessorioRoutes_exports);
...
router.get("/acessorios", getAllAcessorios2).get("/acessorios/:id", getAcessorioById2).post("/acessorios", createAcessorio2).patch("/acessorios/:id", updateAcessorio2).delete("/acessorios/:id", deleteAcessorio2);
var acessorioRoutes_default = router;
