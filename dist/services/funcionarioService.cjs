...
var funcionarioService_exports = {};
__export(funcionarioService_exports, {
  createFuncionarioService: () => createFuncionarioService,
  deleteFuncionarioService: () => deleteFuncionarioService,
  getAllFuncionarioesService: () => getAllFuncionarioesService,
  getFuncionarioByIdService: () => getFuncionarioByIdService,
  updateFuncionarioService: () => updateFuncionarioService
});
module.exports = __toCommonJS(funcionarioService_exports);
...
0 && (module.exports = {
  ...
  getAllFuncionarioesService,
  getFuncionarioByIdService,
