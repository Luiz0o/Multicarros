...
var usuarioService_exports = {};
__export(usuarioService_exports, {
  createUsuario: () => createUsuario2,
  deleteUsuario: () => deleteUsuario,
  getAllUsuarios: () => getAllUsuarios2,
  getUsuarioById: () => getUsuarioById2,
  updateUsuario: () => updateUsuario
});
module.exports = __toCommonJS(usuarioService_exports);
