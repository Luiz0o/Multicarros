...
var clienteService_exports = {};
__export(clienteService_exports, {
  createClienteService: () => createClienteService,
  deleteClienteService: () => deleteClienteService,
  getClienteByIdService: () => getClienteByIdService,
  getClientesService: () => getClientesService,
  updateClienteService: () => updateClienteService
});
module.exports = __toCommonJS(clienteService_exports);
